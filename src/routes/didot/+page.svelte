...
<p>
	...
	commissioned by Louis XIV in 1692 to be the official typeface of the Royal French Print Office.
	And it was designed by a committee of designer's and engineer's rather than by a traditional punch
	cutter.the letter forms were derived from a mathematically precise grid rather than the organic
	forms of handwriting.
</p>
<p>
	It's also significant that these illustrations of the type are engraved rather than letter press
	printed. Engraving and etching were illustration techniques popular at the time that allowed for
